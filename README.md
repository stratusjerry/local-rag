...
Supports three LLM backends: **Ollama** (local), **LM Studio** (local), and **AWS Bedrock** (Claude 4.5 Sonnet).
...
llm/bedrock_client.py     — AWS Bedrock LLM provider (Claude 4.5 Sonnet)
